# scafctl-plugin-identity - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **identity** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-identity/main.go` calls `sdkplugin.Serve()`
